...
if($unpaid_amount != 0) {
  $_SESSION['message'] = 'Unpaid amount is $' . $unpaid_amount;
}
...
<br />
<div id="content">
  <a class="back-link" href="<?php echo url_for('/staff/managers/manage_invoice.php?id=' . h(u($policy_id))); ?>">&laquo; back to invoices</a>
